public class AlternativTabella {
  ...
  public static void main(String[] args) {
    ...
    while (amig) {
        ...
        for (int i = 0; i < h.length; ++i) {
            //hv[i] = h[i];
            hv[i] = d * h[i] + (1.0 - d) / L.length;    //azért kell 1.0-val osztani h double legyen a típusa az osztásnak
  ...
  public static void rendezCsapatok(String[] s, double h[], String[] e, int ep[]) {
    ...
    java.util.Collections.reverse(rendezettCsapatok);   //a sorrendet megfordítja
    ...
    while (iterv.hasNext()) {
        ...
        int idx = ds.indexOf(".");  //a ds stringben a . helyének az indexét adja vissza
        StringBuffer sb = new StringBuffer();   //olyan string ami szerkeszthető a létrehozás után is
        sb = sb.delete(0, sb.length());     //a 0. helytől a length.ik helyik törli a tartalmát
        sb.append(ds.substring(0, idx + 5));    //a 0tól az ind+5. helyik hozzáfűz
